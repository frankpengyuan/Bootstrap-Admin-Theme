    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                if (!empty($_POST["add_member_ID"]))
                {
                    if ($add_member_err_msg != "") { ?>
                        <div class="alert alert-error">
                            <button class="close" data-dismiss="alert">&times;</button>
                            <strong>Error! </strong><?php echo $add_member_err_msg;?>.
                        </div>
                    <?php } else {?>
                ...
                {
                    if ($modify_member_err_msg != "") { ?>
                        <div class="alert alert-error">
                            <button class="close" data-dismiss="alert">&times;</button>
                            <strong>Error! </strong><?php echo $modify_member_err_msg;?>.
                        </div>
                    <?php } else {?>
                        <div class="alert alert-success">
                            <button class="close" data-dismiss="alert">&times;</button>
                                ...
                                <div class="span12">
                                   ...
                                   <div class="table-toolbar">
                                      <div class="btn-group">
                                        ...
                                        <input type="text" class="span8" name="add_member_ID" placeholder="User ID / Student ID">
                                              ...
                                              while($mem_info = $new_result->fetch_array())
                                              {
                                                ...
                                                if ($new2_result) {
                                                    ...
                                                    <tr class="<?php if($odd_even==0) {echo "odd gradeX";}else{echo "even gradeC";}?>">
                                                        ...
                                                        <td class="center"><?php echo $person_info['stuID'];?></td>
                                                        ...
                                                        <td class="center">
                                                            <a href="<?php $tmp=admin_echo(!$he_is_admin); echo $_SERVER["PHP_SELF"]."?action=".$tmp."&who=".$person_info['stuID']."&org=".$row_org['org_name'];?>">Set <?php echo admin_echo(!$he_is_admin); ?></a> /
                                                            <a href="<?php echo $_SERVER["PHP_SELF"]."?action=delete&who=".$person_info['stuID']."&org=".$row_org['org_name'];?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
                                   ...
                                   <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php echo $_SERVER["PHP_SELF"];?>">
                                    <fieldset>
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="text" class="input-xlarge" name="usr_name" placeholder="FirstName LastName">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">ID </label>
                                          <div class="controls">
                                            <input type="text" class="input-xlarge" name="usr_ID" placeholder=" User ID / Student ID">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">Initial Password </label>
                                          <div class="controls">
                                            <input type="password" class="input-xlarge" name="usr_password" placeholder="password">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">Initial Password Again</label>
                                          <div class="controls">
                                            <input type="password" class="input-xlarge" name="usr_password_again" placeholder="password">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">Email </label>
                                          <div class="controls">
                                            <input type="text" class="input-xlarge" id="typeahead" name="usr_email" placeholder="eg. example@example.xxx">
                                          </div>
                                        </div>
                                        <div class="control-group">
                                          <label class="control-label" for="typeahead">Phone </label>
                                          <div class="controls">
                                            <input type="text" class="input-xlarge" id="typeahead" name="usr_phone" placeholder="eg. +86 12345678910">
                                          </div>
                                        </div>
                                        <div class="control-group">
